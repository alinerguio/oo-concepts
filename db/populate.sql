...
insert into funcionario values (1, 'Alice', 'Cozinherx');
insert into funcionario values (2, 'João', 'Ajudante');
insert into funcionario values (3, 'Maria', 'Equipe de Limpeza');
insert into funcionario values (4, 'José', 'Cozinherx');
insert into funcionario values (5, 'Ricardo', 'Ajudante');
insert into funcionario values (6, 'Joana', 'Equipe de Limpeza');
insert into funcionario values (7, 'Daniel', 'Cozinherx');
insert into funcionario values (8, 'Luna', 'Ajudante');
insert into funcionario values (9, 'Eduardo', 'Equipe de Limpeza');
insert into funcionario values (10, 'Eduarda', 'Cozinherx');